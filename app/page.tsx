            ...
            {[
              {
                ...
                title: "辰砂",
                meta: "深紅が映える代表作",
                body: "窯の中で釉薬が変化する「窯変（ようへん）」を巧みにコントロールし、辰砂の赤に紫や藍色が混じり合った景色を生み出しました。この「窯変辰砂」は、今岡町直の代名詞です。",
              ...
              },
              {
                ...
                title: "梅花皮（かいらぎ）",
                meta: "肌理が語る景色",
                body: "彼のもう一つの代名詞が「梅花皮」と呼ばれる技法です。素地と釉薬の収縮率の違いを利用して表面に大きな貫入を生み、その模様が梅の木の皮に似ていることから名付けられました。美しく均一な梅花皮を作り出すには高度な技術が要求され、これも今岡町直が得意とした表現の一つです。",
              ...
              },
              {
                ...
                title: "その他",
                meta: "多彩な作品群",
                body: "金飛ばし、火襷（ひだすき）、銅置、釉裏紅乱斑模様など、今岡町直の独創的な作品群は、伝統技法に独自のアレンジを加えた点に特徴があります。釉薬の化学変化を計算し尽くして再現する技法や、伝統技法を基に独自の感性で斑点を飛ばす技術から、彼の芸術性の高さが伺えます。",
